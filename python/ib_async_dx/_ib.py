...
class Client:
    ...
    def bracketOrder(
        ...
        as well, and so does this: that client sends the field to the gateway
        rather than to the venue, and the gateway holds such an order without
        working it. Kept here for the same reason, and sent when
